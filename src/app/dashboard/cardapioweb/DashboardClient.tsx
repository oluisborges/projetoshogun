      ...
      {metrics && (
        <>
          ...
          >
            ...
            <KpiCard label="Novos clientes" value={String(metrics.newCustomers)} color="#ea580c" />
            <KpiCard label="Clientes recorrentes" value={String(metrics.recurringCustomers)} color="#0891b2" />
          </div>
